...
router.put('/atletas/:id', verificarToken, async (req, res) => {
    ...
    try {
        ...
        await pool.execute(
            `UPDATE competicao SET 
             ...
             WHERE id = ?`,
            [
                a.id_onda || null, a.id_categoria || null, a.numero_peito || null, a.nome || null, a.numero_tag || null,
                a.equipe || null, a.competitivo ? 1 : 0, nascimento_sql, a.sexo || null, a.cpf || null,
    ...
    } catch (error) { res.status(500).json({ erro: "Erro ao atualizar atleta." }); }
});
